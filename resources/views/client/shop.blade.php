...
@section('content')
    ...
    <div class="product-section mt-5 mb-5">
                    ...
                    <div class="col-lg-4 col-md-6 text-center">
                        <div class="single-product-item">
                            <div class="product-image">
                                <a href="#"><img src="{{ url('/foto/'.$d->foto) }}" alt=""></a>
                            </div>
                            <h3>{{ $d->nama }}</h3>
                            <p class="product-price"><span>{{ $d->deskripsi }}</span>Rp. @money($d->harga) </p>
                            <a href="#" data-toggle="modal" data-target="#modalPesan{{ $d->id }}" class="cart-btn"><i class="fas fa-shopping-cart"></i>Pesan Sekarang</a>
                        </div>
                         <!-- Modal Pesan-->
      <div class="modal fade" id="modalPesan{{ $d->id }}" tabindex="-1" aria-labelledby="modalPesan" aria-hidden="true">
      ...
      <input type="hidden"  name="harga" value="{{ $d->harga}}">
        <button type="submit" name="submit" class="btn btn-primary btn-lg">Pesan Sekarang</button>
        </form>
        <!--END FORM Pesan-->
        </div>
        </div>
