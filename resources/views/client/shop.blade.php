        ...
        <div class="container">
            ...
            <div class="row product-lists">
                ...
                <div class="col-lg-4 col-md-6 text-center">
                    <div class="single-product-item">
                        <div class="product-image">
                            <a href="single-product.html"><img src="{{ asset('/img/products/product-img-4.jpg') }}"
                                    alt=""></a>
                        </div>
                        <h3>Avocado</h3>
                ...
                <div class="col-lg-4 col-md-6 text-center">
                    <div class="single-product-item">
                        <div class="product-image">
                            <a href="single-product.html"><img src="{{ asset('/img/products/product-img-5.jpg') }}"
                                    alt=""></a>
                        </div>
                        <h3>Green Apple</h3>
                ...
                <div class="col-lg-4 col-md-6 text-center strawberry">
                    <div class="single-product-item">
                        <div class="product-image">
                            <a href="single-product.html"><img src="{{ asset('/img/products/product-img-6.jpg') }}"
                                    alt=""></a>
                        </div>
                        <h3>Strawberry</h3>
