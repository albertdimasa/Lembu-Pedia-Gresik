                ...
                <div class="row">
                    ...
                    <div class="col-lg-2">
                        <div class="card-header-action">
                            <a href="#" data-toggle="modal" data-target="#modalPesan" class="btn btn-primary">Tambah
                                Data</a>
                        </div>
                    </div>
                </div>
                        ...
                        <tbody>
                            ...
                            @foreach ($produk as $data)
                                <tr>
                                    ...
                                    <td>{{ $data->nama }}</td>
                                    <td>{{ $data->kategori }}</td>
                                    <td>Rp. @money($data->harga)</td>
                                    <td>
                                        <a class="btn btn-secondary btn-sm" data-toggle="modal"
                                            data-target="#modalDetail{{ $data->id }}" href="#">Detail</a>
                                        <a class="btn btn-success btn-sm" data-toggle="modal"
                                            data-target="#modalEdit{{ $data->id }}" href="#">Edit</a>
                                        <a href="#" data-id="{{ $data->id }}"
                                            class="btn btn-danger btn-sm swal-confirm">
                                            <form action="{{ route('delete-produk', $data->id) }}"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="{{ route('update-produk', $data->id) }}"
                                                    class="MultiFile-intercepted" method="POST"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="harga"
                                                            value="@money($data->harga)" onfocus="this.value=''">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Kategori</label>
        ...
        <div class="modal fade" id="modalPesan" tabindex="-1" aria-labelledby="modalPesan" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <!--FORM TAMBAH PRODUK-->
                        <form action="/tambah-produk" class="MultiFile-intercepted" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label for="">Nama</label>
