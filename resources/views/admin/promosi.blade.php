            ...
            <div class="table-responsive">
              <table class="table table-striped table-md">
                ...
                <tr>
                  ...
                  <td>{{ $data->nama }}</td>
                  <td>{{ $data->kategori }}</td>
                  <td><div class="btn-circle btn-primary">{{ $data->diskon }}%</div></td>
                  <td>Rp. {{ $data->hargasesudah }}</td>
                  <td>
                    ...
                    <a href="#" data-id="{{ $data->id }}" class="btn btn-danger btn-sm swal-confirm">
                      <form action="{{ route('delete-promosi',$data->id)}}" id="delete{{ $data->id }}" method="POST">
                          @csrf
                          @method('delete')
                      </form>
                      Hapus</a>
            ...
            <div class="modal-body">
              ...
              <form>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" disabled value="Rp. {{ $data->hargasebelum }}">
                </div>
                <div class="form-group">
                  <label>Diskon</label>
                  <input type="text" class="form-control" disabled value="{{ $data->diskon }}%">
                </div>
                <div class="form-group">
                  <label>Harga Diskon</label>
                  <input type="text" class="form-control" disabled value="Rp. {{ $data->hargasesudah }}">
                </div>
                <div class="form-group">
      ...
      <!-- End Modal Detail-->
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <!--FORM TAMBAH PRODUK-->
              <form action="/tambah-promosi" class="MultiFile-intercepted"
              method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <label>Harga Diskon</label>
                  <input type="text" class="form-control" name="hargasesudah">
                </div>
                <div class="form-group">
                  <label>Diskon</label>
